import { DeleteAttendanceAPI } from "../../../api/Sitemanager/attendance";
...
function DeleteAttendance({ deleteId, onDeleteSuccess, deleteEnable, setDeleteEnable }: deleteProp) {
      ...
      <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-gray-700/50">
        ...
        <div className="space-y-6">
          <p className="text-gray-200 text-sm font-medium text-center">
            Do you want to delete this labour attendance?
          </p>
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              onClick={() => deleteAttendancefun(deleteId)}
            >
              Confirm
            </button>
          </div>
