import { deletePurchaseAPI } from "../../../api/Sitemanager/purchase";
...
function DeletePurchase({ deleteId, onDeleteSuccess, deleteEnable, setDeleteEnable }: deleteProp) {
   if(!deleteEnable) return null
   const deletePurchasefun = async(deleteId:string)=>{
      const response = await deletePurchaseAPI(deleteId)
      if(response.success){
            ...
            <div className="space-y-6">
               ...
               <div className="flex justify-end gap-4">
                  ...
                  <button
                     ...
                     onClick={() => deletePurchasefun(deleteId)}
                  >
                     Confirm
                  </button>
               </div>
