            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
               <div>
                  ...
                  <div className="flex space-x-4">
                     <Phone className="w-5 h-5 text-blue-400" aria-label="Phone" />
                     <Mail className="w-5 h-5 text-blue-400" aria-label="Email" />
                     <MapPin className="w-5 h-5 text-blue-400" aria-label="Location" />
                  </div>
               </div>
               <div>
