          ...
          <form onSubmit={SaveSpecData} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-gray-800/50 border ${ errors.additionalExpense_per ? "border-red-500" : "border-gray-600"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-gray-800/50 border ${ errors.profit_per ? "border-red-500" : "border-gray-600"
                  } rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all duration-200 placeholder:text-gray-400 text-gray-100 text-sm font-medium`}
              />
              {errors.profit_per && (
            ...
            <div>
              ...
              <input
                id="profitAmount"
                type="text"
                value={((final + (final * (editadditionalExpense_per || 0) / 100)) * (editprofit_per || 0) / 100).toFixed(2)}
                readOnly
