          ...
          <table className="min-w-full text-sm bg-gray-800/50">
            <thead className="bg-gray-800/70 text-gray-200 uppercase text-xs font-semibold tracking-wider">
              <tr>
                ...
                <th className="px-6 py-4 text-left">Daily Wage</th>
                    ...
                    <td className="px-6 py-4">
                      <select
                        ...
                        className={`w-full px-4 py-2 bg-gray-800/50 border ${
                          errors[index]?.labour_type ? "border-red-500" : "border-gray-600"
                        } rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all duration-200 text-gray-100 text-sm`}
                      >
                      ...
                      {errors[index]?.labour_type && (
                        <p className="mt-1 text-red-500 text-xs">{errors[index].labour_type}</p>
                      )}
                    </td>
                    <td className="px-6 py-4">
                      <input
                        ...
                        className={`w-full px-4 py-2 bg-gray-800/50 border ${
                          errors[index]?.quantity ? "border-red-500" : "border-gray-600"
                        } rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition-all duration-200 text-gray-100 text-sm placeholder:text-gray-400`}
                      />
                      {errors[index]?.quantity && (
                        <p className="mt-1 text-red-500 text-xs">{errors[index].quantity}</p>
                      )}
                    </td>
