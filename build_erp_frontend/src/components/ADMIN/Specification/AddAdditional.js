...
function AddAdditionalSpec({ fetchSpecList }) {
    const { spec_id, spec_name, spec_unit, description, AddAdditionalEnable, setAddAdditionalEnable, labourDetails, materialDetails, additionalExpense_per, setAdditionalExpense, profit_per, setProfit, } = useContext(AppContext);
    if (!AddAdditionalEnable)
        return null;
