...
function ListEstimation() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6 sm:p-8 relative">
      <div className="max-w-6xl mx-auto bg-gray-800/30 rounded-2xl shadow-xl border border-gray-700/50 p-6 sm:p-8">
        ...
        <div className="overflow-x-auto rounded-xl border border-gray-700/50 mt-4">
