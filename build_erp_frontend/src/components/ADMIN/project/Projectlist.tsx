    ...
    <div className="p-6 sm:p-8 min-h-screen bg-gray-900">
      <div className="bg-gray-800/90 backdrop-blur-sm shadow-2xl rounded-2xl p-6 sm:p-8 max-w-7xl mx-auto border border-gray-700/50">
        ...
        <div className="overflow-x-auto rounded-xl border border-gray-700/50">
          ...
          <ReUsableTable<ProjectType> data={projectList} dataKey={dataKey} heading={heading} page={page} setDeleteEnable={setDeleteEnable}
      ...
      <ChangeStatus project_id={changeProjectId} status={changeStatus} enable={changeEnable} setEnable={setChangeEnable} onChangeSuccess={fetchData} />

      <EditProject editData={editData} editEnable={editEnable} setEnableEdit={setEditEnable} onEditSuccess={fetchData} />

      <ReUsableDeleteModal enable={deleteEnable} deleteId={deleteId} setEnable={setDeleteEnable} onDeleteSuccess={fetchData}
        api={deleteProjectData} deleteItem="Project" />
    </div>
