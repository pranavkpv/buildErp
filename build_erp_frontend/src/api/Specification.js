...
// ---------------- Material Sum ---------------- //
export const sumOfMaterialFun = async (input) => {
...
// ---------------- Labour Sum ---------------- //
export const sumOfLabourFun = async (input) => {
...
export const fetchSpec = async (page, search) => {
...
// ---------------- Save New Spec ---------------- //
export const SaveSpec = async (input) => {
    const response = await adminAxios.post("/spec", input);
    return response.data;
};
// ---------------- Update Spec ---------------- //
export const UpdateSpec = async (input) => {
...
export const fetchSum = async (materialDetails, labourDetails) => {
...
// ---------------- Delete Spec ---------------- //
export const DeleteSpecFunction = async (id) => {
...
export const getMaterialsBySpecs = async (specIds) => {
