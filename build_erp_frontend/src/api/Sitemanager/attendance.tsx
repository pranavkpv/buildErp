...
export const DeleteAttendanceAPI =async(deleteId:string)=>{
   const result = await axioInstance.delete("/site/attendance",{params:{id:deleteId}})
   return result.data
}

export const approveAttendanceAPI = async(approveId:string)=>{
   const result = await axioInstance.put("/site/attendance",{},{params:{id:approveId}})
   return result.data
}

export const getAttendanceBYIdAPI = async(editId:string)=>{
   const result  = await axioInstance.get("/site/editfetchattendance",{params:{_id:editId}})
   return result.data
}
