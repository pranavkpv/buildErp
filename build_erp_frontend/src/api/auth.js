...
// ---------------- User Signup ---------------- //
export const userSignupApi = async (input) => {
    const response = await authAxios.post('/signup', input);
    return response.data;
};
// ---------------- user signup Verify OTP ---------------- //
export const verifyOTPAPI = async (input) => {
...
// ---------------- User Login ---------------- //
export const userLoginAPI = async (input) => {
