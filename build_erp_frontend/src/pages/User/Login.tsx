      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors duration-200 text-gray-100 placeholder-gray-400 text-sm"
          />
        ...
        <div>
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              value={password}
              className="w-full px-4 py-3 bg-gray-800/30 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 text-gray-100 placeholder-gray-400 text-sm pr-12"
            />
            <button type="button"
