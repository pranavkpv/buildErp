import { IUpdateProfileImageUseCase } from "../../interfaces/UserUseCaseEntities/AuthenticationUseCaseEntities/IUpdateProfileImage.usecase";
...
export class UpdateProfileImageUseCase implements IUpdateProfileImageUseCase {
   ...
   async execute(url: string, _id: string):Promise<commonOutput<{ userData: userLoginDTO; tokens: Tokens }> | commonOutput> {
