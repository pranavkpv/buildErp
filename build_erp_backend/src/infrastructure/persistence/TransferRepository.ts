...
import { fetchTransferInput, materialData, projectData, transferInput, transferModel, TransferOutput } from "../../DTO/PurchaseEntity.ts/Transfer";
...
export class TransferRepository implements ITransferRepositoryEntity {
