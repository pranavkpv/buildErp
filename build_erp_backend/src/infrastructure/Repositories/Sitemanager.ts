...
export class SitemanagerRepository implements ISitemanagerRepository {
   ...
   async getSitemanagerForEdit(_id: string, email: string): Promise<ISitemanagerModelEntity | null> {
   ...
   async removeSitemanagerById(_id: string): Promise<void> {
   ...
   async getSitemanagerById(_id: string): Promise<ISitemanagerModelEntity | null> {
