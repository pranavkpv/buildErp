export const SpecSuccessMessage = {
...
export const SpecFailedMessage = {
    ...
    EXIST_ID: 'Spec Id already exists',
    SPEC_ID_MISS: 'Should add at least one specification',
    ...
    MATERIAL_QTY_POSITIVE: 'must be a positive number greater than 0 in all material',
    ...
    LABOUR_HOURS_POSITIVE: 'must be a positive hour greater than 0',
